...
![screenshot](https://github.com/Cyanhead/404-not-found-master/Screenshot.png)
...
You can find links to the demo, as well as the code at the top.
...
The responsiveness of the page is achieved using "display: flex;". Oh how i love flex 😄.
